...
1. Play this [UX Flaws Game](https://cantunsee.space/). It will teach you about best practices when it comes to designing specific sections, like a chat box or an icon row, of your website or app.

2. Command Line Tool Coding Walkthrough. Together we are going to develop a little app that helps pick a random person from a group and one that shuffles a group of people to form groups. We will also introduce the concept of [DocBlocks](https://devdocs.magento.com/guides/v2.4/coding-standards/docblock-standard-javascript.html) to make our code more professional.

3. CSS Kata Coding Walkthrough

4. Exercises & Comparing Solutions

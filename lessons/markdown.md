...
- _Superset_ of HTML
- File Extension: `.md`
- Flavours: "dialects" of markdown that extend the range of different elements you can use, e.g. with Stackoverflow flavoured Markdown you can write spoilers like this `>! This is a spoiler` 
...
- Create a personal manual! Use this [template](resources/personal_manual_template.md) and personalize it to your liking! Try to use as many different formatting options as possible.
After you are finished, introduce yourself in pairs.
Use [mine](resources/manual_val.md) as an inspiration
